        ...
        <div className="flex flex-col justify-center items-center w-full gap-10">
                <form className="flex flex-col w-[80%] md:w-[60%] gap-10">
                    <div className="flex flex-col">
                        <label htmlFor="name" aria-required className="text-base md:text-lg lg:text-xl">Name</label>
                        <input type="text" id="name" name="name" className="py-2 px-4 font-redditMono border-1" />
                    </div>

                    <div className="flex flex-col">
                        <label htmlFor="email" aria-required className="text-base md:text-lg lg:text-xl">Email</label>
                        <input type="email" id="email" name="email" className="py-2 px-4 font-redditMono border-1" />
                    </div>

                    <div className="flex flex-col">
                        <label htmlFor="email" aria-required className="text-base md:text-lg lg:text-xl">Message</label>
                        <textarea type="message" id="message" name="message" className="py-3 px-4 font-redditMono border-1" />
                    </div>

                    <div>
                        <input type="submit" value="Send" className="px-7 pt-3 pb-2 bg-purple text-sm lg:text-lg uppercase" />
                    </div>
                </form>
        </div>
    )

        ...
        <footer className="relative flex flex-col h-screen justify-between gap-8">
            <div className="flex justify-center items-center h-screen">
                <div className="flex flex-col justify-center items-center gap-16 my-40">
                    <h2 className="font-josefin text-4xl sm:text-7xl md:text-8xl font-bold text-center m-0 leading-15 sm:leading-20 md:leading-27">Let&apos;s get<br></br> connected!</h2>

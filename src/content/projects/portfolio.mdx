...
gallery: [
    {
        section: 'The Vision',
        media: [
            { type: 'image', src: '/portfolio/images/vision1.webp', alt: 'Figma mockup for home page of portfolio' },
            { type: 'image', src: '/portfolio/images/vision2.webp', alt: 'Figma mockup for web pages of portfolio' },
            { type: 'image', src: '/portfolio/images/vision3.webp', alt: 'Color palette explanation for portfolio' },
        ]
    },
    {
        section: 'Technical Architecture',
        media: [
            { type: 'image', src: '/portfolio/images/tech1.webp', alt: 'Component hierarchy of portfolio' },
        ]
    },
    {
        section: 'Animating Using Motion',
        media: [
            { type: 'video', src: '/portfolio/videos/motion1.mp4', alt: 'Video of animations from portfolio home page' },
        ]
    },
    {
        section: 'Inclusive by Design',
        media: [
            { type: 'image', src: '/portfolio/images/inclusive1.webp', alt: 'Light and dark mode contrast for portfolio' },
            { type: 'image', src: '/portfolio/images/inclusive2.webp', alt: 'Color contrast for portfolio' },
        ]
    },
    {
...
<MediaGallery section="The Vision" />
...
<MediaGallery section="Technical Architecture" />
...
<MediaGallery section="Animating Using Motion" />
...
<MediaGallery section="Inclusive by Design" />
...
<MediaGallery section="Personal Growth" />

...
gallery: [
    {
        section: 'The Personal Spark',
        media: [
            { type: 'video', src: '/auralyst/videos/spark.mp4', alt: '' },
        ]
    },
    {
        section: 'Foundational Playground',
        media: [
            { type: 'video', src: '/auralyst/videos/playground.mp4', alt: '' },
        ]
    },
    {
        section: 'Building Interactivity',
        media: [
            { type: 'video', src: '/auralyst/videos/interactivity.mp4', alt: '' },
        ]
    },
    {
        section: 'Embracing Challenges',
        media: [
            { type: 'video', src: '/auralyst/videos/challenges.mp4', alt: '' },
        ]
    },
    {
        section: 'Vision and Growth',
        media: [
...
<MediaGallery section="The Personal Spark" />
...
<MediaGallery section="Foundational Playground" />
...
<MediaGallery section="Building Interactivity" />
...
<MediaGallery section="Embracing Challenges" />
...
<MediaGallery section="Vision and Growth" />
